 ...
 <header id="header">
    ...
    <nav class="uk-navbar-container uk-navbar-transparent" uk-navbar>
        ...
        <div class="uk-navbar-right red-on-hover">
            <ul class="uk-navbar-nav">
                <li class="uk-parent uk-visible@m"><a class="text-menu" href="/seguridad/showRegistrationForm">Registrarse</a></li>
                <li class="uk-parent uk-visible@m"><a class="text-menu" href="/seguridad/showLoginForm">Ingresar</a></li>
    ...
    <nav id="menu-responsivo" uk-offcanvas class="uk-hidden@m">
        <div class="uk-offcanvas-bar">
            ...
            <ul class="uk-nav-default uk-nav-parent-icon" uk-nav="multiple: true">
                ...
                <li class="uk-parent">
                    <a href="#" class="text-menu">Caracteristicas</a>
                    <ul class="uk-nav-sub">
                        <li class=""><a class="text-menu" href="/#lstCaractFuncUsuario">Usuario</a></li>
                        <li class=""><a class="text-menu" href="/#lstCaractTenicas">Técnicas</a></li>
                    </ul>
                </li>
                ...
                <li><a class="text-menu" href="/seguridad/showRegistrationForm">Registrarse</a></li>
                <li><a class="text-menu" href="/seguridad/showLoginForm">Ingresar</a></li>
            </ul>
        </div>
    </nav>
</header>
