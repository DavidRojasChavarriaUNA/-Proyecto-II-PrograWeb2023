  ...
  <main class="uk-container">
            ...
            <ul class="uk-slideshow-items">
              <li>
                <section>
                  ...
                  <p class="textoEnCarrusel pTextoImg1">El voto es un derecho y un secreto, garantizamos su secreto y
                    seguridad al votar con nuestra herramienta</p>
                  <img src="/public/assets/imagenes/presentación.webp" alt="" uk-cover class="img-responsive">
                </section>
              </li>
              <li>
                <section>
                  <img src="/public/assets/imagenes/diseño responsivo.jpeg" alt="" uk-cover class="img-responsive">
                  <h1 class="textoEnCarrusel h1TextoImg2">Diseño adaptable</h1>
                  <p class="textoEnCarrusel pTextoImg2">No importa el tamaño del dispositivo del usuario, nuestra
              ...
              <li>
                <section>
                  ...
                  <p class="textoEnCarrusel pTextoImg3">Visualización de resultados en tiempo real conforme son recibidas
                    las respuestas.</p>
                </section>
              </li>
            </ul>
      ...
      <article class="uk-article">
        ...
        <section class="uk-text-center uk-margin">
          <div class="uk-card uk-card-default uk-card-body uk-text-center">
            <h4>Empresas reconocidas internacionalmente confian en nosostros, animate a ser parte de nuestra familia</h4>
          </div>
        </section>
      </article>
    </section>
        ...
        <article class="uk-width-1-2@s uk-width-1-3@m">
          <section class="uk-card uk-card-default">
            <div class="uk-card-header">
              <div class="uk-grid-small uk-flex-middle" uk-grid>
                <div class="uk-width-auto">
                  <img class="img-responsive" style="max-width: 100px;" src="/public/assets/imagenes/Mail.png">
                </div>
            ...
            <div class="uk-card-body">
              <p>Se envian los enlaces para votar a los que sean de interes por medio de correo electrónico</p>
            </div>
          </section>
        </article>
        <article class="uk-width-1-2@s uk-width-1-3@m">
          <section class="uk-card uk-card-default">
            <div class="uk-card-header">
              <div class="uk-grid-small uk-flex-middle" uk-grid>
                <div class="uk-width-auto">
                  <img class="img-responsive" style="max-width: 100px;" src="/public/assets/imagenes/Voto.png">
                </div>
                <div class="uk-width-expand">
            ...
            <div class="uk-card-body">
              <p>El voto se realiza de forma segura, confiable y confidencial, nadie podrá identificar el dueño del
                resultado</p>
            </div>
          </section>
        </article>
        <article class="uk-width-1-1@s uk-width-1-3@m">
          <section class="uk-card uk-card-default">
            <div class="uk-card-header">
              <div class="uk-grid-small uk-flex-middle" uk-grid>
                <div class="uk-width-auto">
                  <img class="img-responsive" style="max-width: 100px;" src="/public/assets/imagenes/formulario.png">
                </div>
                <div class="uk-width-expand">
    ...
    <section id="lstCaractTenicas"
      ...
      <article class="uk-height-large uk-background-cover uk-overflow-hidden uk-light uk-flex"
        ...
        <section class="uk-width-1-2@m uk-text-center uk-margin-auto uk-margin-auto-vertical">
          <h1 class="text-white" uk-parallax="opacity: 0,1; y: -100,0; scale: 2,1; end: 50vh + 50%;">Integridad de datos
          </h1>
          <p class="text-white" uk-parallax="opacity: 0,1; y: 100,0; scale: 0.5,1; end: 50vh + 50%;">la protección de
      ...
      <article class="uk-height-large uk-background-cover uk-overflow-hidden uk-light uk-flex"
        ...
        <section class="uk-width-1-2@m uk-text-center  uk-margin-auto" style="margin-top: 300px;">
          <h1 class="text-white" uk-parallax="opacity: 0,1,1; y: -100,0,0; x: 100,100,0; scale: 2,1,1; end: 50vh + 50%;">
            Servicio disponible</h1>
          <p class="text-white"
            uk-parallax="opacity: 0,1,1; y: 100,0,0; x: -100,-100,0; scale: 0.5,1,1; end: 50vh + 50%;">plataforma
            dispoible en tiempo real, para realizar las votaciones en cualquier momento con una gran cantidad de usuarios
            simultaneamente</p>
        </section>
      </article>
      <article class="uk-height-large uk-background-cover uk-overflow-hidden uk-light uk-flex"
        ...
        <section class="uk-width-1-2@m uk-text-center">
          ...
          <p class="text-white"
            uk-parallax="opacity: 0,1,1; y: 100,0,0; x: -100,-100,0; scale: 0.5,1,1; end: 50vh + 50%;">T odas las
            actividades realizadas se registran en los logs, cualquier actividad inusual se notifica al administrador</p>
        </section>
      </article>
    </section>
          ...
          <div>
            <div class="uk-card uk-card-default">
              ...
              <div class="uk-card-body">
                ...
                <p>Acceda a datos de las votaciones en tiempo real desde cualquier dispositivo, gracias a nuestro diseño
                  responsivo</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div class="uk-card uk-card-default">
              ...
              <div class="uk-card-body">
                ...
                <p>Tenemos a su disposición gran cantidad de opciones de reportería y herramientas de análisis</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
        ...
        <div class="uk-align-center uk-text-middle">
          <div class="uk-card-body uk-height-1-1">
            ...
            <p>A medida que preparas las elecciones o mientras éstas suceden, pueden surgir dudas, aquí estamos para lo
              que necesites</p>
          </div>
        </div>
      </div>
      ...
      <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
        ...
        <div class="uk-text-middle uk-align-center">
          <div class="uk-card-body">
            ...
            <p>Independientemente de las necesidades de tu organización, con nuestros diferentes planes, te aseguramos que
        ...
        <section class="uk-width-1-3@m">
          <div class="uk-card uk-card-default">
            <div class="uk-card-header">
              <div class="uk-grid-small uk-flex-middle" uk-grid>
                <div class="uk-width-auto">
                  <img class="uk-border-circle" width="40" height="40" src="/public/assets/imagenes/happyFacepng.png">
                </div>
                <div class="uk-width-expand">
        ...
        <section class="uk-width-1-3@m">
          <div class="uk-card uk-card-default uk-margin">
            <div class="uk-card-header">
              <div class="uk-grid-small uk-flex-middle" uk-grid>
                <div class="uk-width-auto">
                  <img class="uk-border-circle" width="40" height="40" src="/public/assets/imagenes/nerdFace.jpg">
                </div>
                <div class="uk-width-expand">
        ...
        <section class="uk-width-1-3@m">
          <div class="uk-card uk-card-default uk-margin">
            <div class="uk-card-header">
              <div class="uk-grid-small uk-flex-middle" uk-grid>
                <div class="uk-width-auto">
                  <img class="uk-border-circle" width="40" height="40" src="/public/assets/imagenes/cooldFace.png">
                </div>
                <div class="uk-width-expand">
    ...
    <section id="registro" class="uk-section uk-section-muted uk-margin">
      ...
      <div class="uk-text-center">
        <a href="/seguridad/register" class="uk-button uk-button-primary uk-button-large">Registro</a>
      </div>
    </section>
  </main>
